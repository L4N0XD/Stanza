...
class DadosComercial(models.Model):
    ...
    vl_original = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    ind_dt_base = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    ind_dt_calc = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    correcao = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    porc_juro_contr = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    dt_base_juro = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    dt_calc_juro = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    juro_contr = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    porc_multa = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    porc_juros = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    porc_pro_rata = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    multa = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    juros = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    pro_rata = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    total = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    valor_devido = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    dias = models.IntegerField(null=True,blank=True)
    dt_recto = models.DateField(null=True, blank=True)
    valor_pago = models.DecimalField(null=True,max_digits=10, decimal_places=2)
    ...
    total_lanc = models.DecimalField(null=True,max_digits=10, decimal_places=2)
